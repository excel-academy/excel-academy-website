...
import TitleIntro from '../title-intro/title-intro';
import MaxWidthBox from '../max-width-box/max-width-box-css';
import UpcomingDate from '../upcoming-date/upcoming-date';
import { HTMLContent } from '../content/content';
import PageNavBar from '../page-nav-bar/page-nav-bar';
import FormOpenHouse from '../form-open-house/form-open-house';
import AdmissionPolicy from '../admission-policy/admission-policy';
